...
$referral_reward = array(
    "1" => "0.06,CASH,REFERRAL_1", // reward = 6% from networth user
    "2" => "50,CRYSTAL,REFERRAL_2", // reward = 50 crystal
    "3" => "0.06,CASH,REFERRAL_3", // reward = 6% from networth user
    "4" => "50,CRYSTAL,REFERRAL_4", // reward = 50 crystal
);